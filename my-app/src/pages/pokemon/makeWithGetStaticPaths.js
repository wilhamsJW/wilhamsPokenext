...
/********************************
 * Done as an example with getStaticPaths()
 *
 * Analyzing in detail what would be better to decide not to use it anymore
 *
 * Because the React Query lib fetches the data and caches it smarter and faster and
 * speeds up my system performance
 * 
 * I'm learning english, Sorry :)
 */

/********************************
 * Feito como exemplo com getStaticPaths()
 * 
 * Analisando detalhadamente o que seria melhor decidir não usar mais ele
 * 
 * Pois a lib React Query busca os dados e armazena em cache de forma mais inteligente e rápida e
 * acelera o desempenho do meu sistema
 */
